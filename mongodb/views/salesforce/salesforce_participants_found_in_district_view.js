db.salesforce_participants_found_in_district_view.drop();
db.createView("salesforce_participants_found_in_district_view","mulesoft_api_responses_enrollments_found_view",
  ...
  [
    ...
    {
      $match: {
        "matching_district_participants_index" : 0
      }
    },
  ]
);