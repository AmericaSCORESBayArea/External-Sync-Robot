//removes the view
db.district_1_system_registration_sheet_mismatch_gender.drop();

//creates a new view
db.createView("district_1_system_registration_sheet_mismatch_gender","district_1_registration_sheet_participants_view",
    ...
    [
      ...
      // Stage 4
      {
        $project: {
          ...
          "district_1SystemValue" : "$matchingDISTRICT_1Registration.formValues.Gender"
        }
      },
