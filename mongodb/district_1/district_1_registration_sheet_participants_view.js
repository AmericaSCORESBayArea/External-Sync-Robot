//removes the view
db.district_1_registration_sheet_participants_view.drop();

//creates a new view
db.createView("district_1_registration_sheet_participants_view","district_1_registration_sheet_teams_view",
