//removes the view
db.district_2_attendance_sheet_participants_view.drop();

//creates a new view
db.createView("district_2_attendance_sheet_participants_view","district_2_attendance_sheet_teams_view",
