//removes the view
db.district_2_system_registration_sheet_mismatch_zip.drop();

//creates a new view
db.createView("district_2_system_registration_sheet_mismatch_zip","district_2_registration_sheet_participants_view",
    ...
    [
      ...
      // Stage 4
      {
        $project: {
          ...
          "district_2SystemValue" : "$matchingDISTRICT_2Registration.formValues.Zip",
          "compare" : {
            "$cmp" : [
              "$sheetValue",
