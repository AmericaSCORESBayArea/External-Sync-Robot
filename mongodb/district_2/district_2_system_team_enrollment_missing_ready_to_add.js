//removes the view
db.district_2_system_team_enrollment_missing_ready_to_add.drop();

//creates a new view
db.createView("district_2_system_team_enrollment_missing_ready_to_add","district_2_system_team_enrollment_missing_view",
